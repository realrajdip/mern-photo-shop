    ...
    <nav
      className={`flex flex-col sm:flex-row justify-between items-center px-6 py-4 ${
        pathname === "/seller/profile" || pathname === "/buyer/profile"
          ? "hidden"
          : "fixed"
      } top-0 left-0 right-0 shadow-lg z-30 bg-white`}
    >
      <div className="flex items-center gap-4">
        <img
          src="/picprismlogo.png"
          alt="logo"
      ...
      <ul className="flex gap-6 mt-4 sm:mt-0 text-lg text-gray-600">
        <li>
          <Link
            to="/"
            className="rounded-md p-2 hover:bg-black hover:text-white transition-colors duration-300"
          >
            About
          </Link>
        </li>
